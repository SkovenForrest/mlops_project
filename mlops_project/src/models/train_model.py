...
def train(config):
    ...
    trainer = Trainer(max_epochs=10, max_steps=2000, limit_train_batches=0.20, callbacks=[checkpoint_callback, early_stopping_callback],
            logger=pl.loggers.WandbLogger(project="mlops-final-project"),profiler="simple")
