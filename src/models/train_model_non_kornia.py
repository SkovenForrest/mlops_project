...
def train(config):
    ...
    train_dataset = AnimalDataset(train_targets,train_img_list,dir_dataloader,transform=transform_train)
    test_dataset  = AnimalDataset(test_targets,test_img_list,dir_dataloader, transform=transform_test)
